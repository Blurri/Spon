...
module.exports=require('xagiSe');
},{}],"xagiSe":[function(require,module,exports){
...
},{}],"P/MueZ":[function(require,module,exports){
var global=typeof self !== "undefined" ? self : typeof window !== "undefined" ? window : {};(function browserifyShim(module, exports, define, browserify_shim__define__module__export__) {
/*!
...
module.exports=require('GlrHcP');
},{}],"GlrHcP":[function(require,module,exports){
var global=typeof self !== "undefined" ? self : typeof window !== "undefined" ? window : {};(function browserifyShim(module, exports, define, browserify_shim__define__module__export__) {
//! moment.js
//! version : 2.5.1
...
},{"./controllers/events":2,"./router":3,"moment":15}],2:[function(require,module,exports){
/*
Dependencies
*/
...
},{"../../views/detailEvent.hbs":4,"../../views/myEvents.hbs":5,"../../views/newEvent.hbs":6,"hbsfy/runtime":14}],3:[function(require,module,exports){
...
function program3(depth0,data) {
  ...
  buffer += "<divc id=\"chatWrapper\">\n	<div id=\"attributesBox\">\n		<label>Where:</label>\n		<p>";
  if (helper = helpers.where) { stack1 = helper.call(depth0, {hash:{},data:data}); }
  else { helper = (depth0 && depth0.where); stack1 = typeof helper === functionType ? helper.call(depth0, {hash:{},data:data}) : helper; }
  buffer += escapeExpression(stack1)
    + "</p>\n		<label>When:</label>\n		<p>";
  ...
  buffer += escapeExpression(stack1)
    ...
    + "</p>\n		<div id=\"joinLeaveButton\">\n			";
  stack1 = (helper = helpers.checkMembers || (depth0 && depth0.checkMembers),options={hash:{},inverse:self.noop,fn:self.program(1, program1, data),data:data},helper ? helper.call(depth0, (depth0 && depth0.members), options) : helperMissing.call(depth0, "checkMembers", (depth0 && depth0.members), options));
